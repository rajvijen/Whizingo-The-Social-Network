...
function useAutocomplete(props) {
  ...
  var firstFocus = _react.default.useRef(true);
  ...
  var highlightedIndexRef = _react.default.useRef(defaultHighlighted);

  var selectedIndexRef = _react.default.useRef(-1);
  ...
  var _React$useRef = _react.default.useRef(valueProp !== undefined),
      isControlled = _React$useRef.current;

  var _React$useState4 = _react.default.useState(function () {
  ...
  var _React$useRef2 = _react.default.useRef(inputValueProp != null),
    ...
    if (multiple) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        if (typeof optionLabel !== 'string') {
          console.error(['Material-UI: the `getOptionLabel` method of useAutocomplete do not handle the options correctly.', "The component expect a string but received ".concat((0, _typeof2.default)(optionLabel), "."), "For the input option: ".concat(JSON.stringify(newValue), ", `getOptionLabel` returns: ").concat(newInputValue, ".")].join('\n'));
        }
      }
  ...
  var _React$useRef3 = _react.default.useRef(openProp != null),
